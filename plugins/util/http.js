    ...
    events: [{
        ...
        exec: function(c) {
            ...
            app.get("/commands", async (req, res) => {
                ...
                for (let command of c.allCommands) {
                    if (req.url.includes("hide" + command.category)) {
                        continue;
                    }
                    if (req.url.includes("hideMaintainer") && command.stipulations.maintainer) {
                        continue;
                    }
                    if (!cats[command.category]) {
