	...
	commands: [
		{
			...
			execute: async(c, m, a) => await fetch("http://inspirobot.me/api?generate=true").then(async r => m.reply({ embed: new Discord.MessageEmbed().setTitle("Inspirational Quote*").setDescription(`I just cooked up a hot new inspirational quote*`)
