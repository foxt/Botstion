...
module.exports = {
	...
	commands: [{
		...
		execute: async(c, m, a) => {
			...
			.setTitle("Botstion⁴")
	  .setDescription(`Developed by [theLMGN](https://thelmgn.com), [Netx](http://ndg.ovh) and [SunburntRock89](https://twitter.com/sunburntrock89) in 2018-19.\n[Contribute](https://github.com/theLMGN/botstion) • [DBL](https://discordbots.org/bot/${c.user.id}) • [Support Server](https://discord.gg/hNgA7va) • [Invite me!](https://discordapp.com/oauth2/authorize?client_id=${c.user.id}&scope=bot&permissions=268561473)`)
